...
const tone: Message = {
    role: "system",
    content:
        "You are a translation assistant. Translate the following words and phrases from one language to another accurately and contextually.",
};
    ...
    args: {
        ...
        prompt: positional({
            ...
            description: indentedDescription([
                ...
                '  - A paragraph (e.g., "Translate this paragraph into French.")',
            ]),
        }),
    },
    handler: handler,
