...
const tone: Message = {
    role: "system",
    content:
        "You are a translation assistant. Translate the following words and phrases from one language to another accurately and contextually. From English to Spanish.",
};
...
const cmd = command({
    ...
    version: "0.1.0",
    aliases: ["t-en-es", "translate-english-spanish"],
    args: {
        ...getOpenAIOptions(),
